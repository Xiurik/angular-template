import { EVENT_MANAGER_PLUGINS, EventManagerPlugin } from './chunk-R3VWRG7W.js';
import { PlatformLocation, XhrFactory, getDOM, parseCookieValue } from './chunk-PYKBECFX.js';
import {
      ...
      tap((event) => {
        if (event instanceof HttpResponse) {
          transferState.set(storeKey, {
            [BODY]:
              req.responseType === 'arraybuffer' || req.responseType === 'blob' ? toBase64(event.body) : event.body,
...
//# sourceMappingURL=chunk-HYD76HNN.js.map
